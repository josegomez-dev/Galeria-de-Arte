...
public class ValidacionForm {
	...
	public static boolean campoTipoCedulaJuridica(TextField pcampo){
		boolean r = false;
		if(pcampo.getText().matches("[0-9]{1}\\-[0-9]{3}\\-[0-9]{6}")){
			r = true;
		}
		return r;
	}

	public static boolean campoTipoCedulaJuridica(TextField pcampo, Label plabel, String pmensaje){
		boolean r = true;
		String c = null;
		if(!campoTipoCedulaJuridica(pcampo)){
			r = false;
			c = pmensaje;
		}
		plabel.setText(c);
	...
	public static boolean campoTipoTelefono(TextField pcampo){
		boolean r = false;
		if(pcampo.getText().matches("[0-9]{4}\\-[0-9]{4}")){
			r = true;
		}
		return r;
	}

	public static boolean campoTipoTelefono(TextField pcampo, Label plabel, String pmensaje){
		boolean r = true;
		String c = null;
		if(!campoTipoTelefono(pcampo)){
			r = false;
			c = pmensaje;
		}
		plabel.setText(c);
